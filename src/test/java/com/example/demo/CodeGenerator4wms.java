...
public class CodeGenerator4wms {
	...
	static final String TABLE_NAME = "AM_SOFT_ZONE";
	static final String ENTITY_NAME = "SoftZone";
	static final String MAPPER_NAME = ENTITY_NAME + "Mapper";
	static final String SERVICE_NAME = ENTITY_NAME + "Service";
	static final String SERVICE_IMPL_NAME = ENTITY_NAME + "Service" + "Impl";
	static final String CONTROLLER_NAME = ENTITY_NAME + "Controller";
    /**
     * <p>
     * 读取控制台内容
     * </p>
...
//        String projectPath = System.getProperty("user.dir");
        ...
        gc.setOutputDir("D:\\repos\\AnjiGit\\wms-parent\\wms-basic-data\\src/main/java");
        gc.setAuthor("auto");
        gc.setOpen(false);
        ...
        dsc.setUrl("jdbc:mysql://10.108.17.27:3306/wms?useUnicode=true&useSSL=false&characterEncoding=utf8");
...
//        pc.setModuleName(scanner("模块名"));
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/src/main/resources/mapper/basic-data"
